...
public class C04_DateTimeFormatter {
    ...
    public static void main(String[] args) {
        ...
        DateTimeFormatter dtf = DateTimeFormatter.ofPattern("dd - MM - YYYY"); // tarih print edecek format hazırlandı

        DateTimeFormatter dtf2 = DateTimeFormatter.ofPattern("HH : mm : ss"); // zaman print edecek format hazırlandı
        ...
        System.out.println("dtf3.format(ldt) = " + dtf3.format(ldt));
